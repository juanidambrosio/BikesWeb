...
namespace BikeSharing.Services.Profiles.Controllers
{
    ...
    public class ProfilesController : BaseApiController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateProfile([FromBody] UserAndProfileModel profile)
        {
        ...
        [HttpPatch]
        public async Task<IActionResult> PatchUpdateProfile([FromBody] UserProfile profile)
        {
        ...
        public async Task<IActionResult> UpdateProfileImage(int userid, [FromBody] UpdateImageModel imageModel)
        {
        ...
        public async Task<IActionResult> SetPaymentData(int userid, [FromBody] PaymentData data)
        {
        ...
        public async Task<IActionResult> SetVoiceProfileId(int userid, [FromBody] Guid id)
        {
            var profile = new UserProfile()
            {
                UserId = userid,
        ...
        public async Task<IActionResult> SetVoiceSecretPhrase(int userid, [FromBody] string phrase)
        {
            var profile = new UserProfile()
            {
                UserId = userid,
        ...
        [HttpPost]
        [Route("byfaceid")]
        public async Task<IActionResult> GetUserProfileByFaceProfileId([FromBody] Guid faceid)
        {
